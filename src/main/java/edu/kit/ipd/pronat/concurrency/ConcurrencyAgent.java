...
import edu.kit.ipd.pronat.concurrency.filter.CorefExtender;
import edu.kit.ipd.pronat.concurrency.filter.GrammarFilter;
import edu.kit.ipd.pronat.concurrency.filter.KeyphraseFilter;
...
public class ConcurrencyAgent extends AbstractAgent {
	...
	private static final Logger logger = LoggerFactory.getLogger(ConcurrencyAgent.class);
